...
import net.greeta.stock.analytics.streamprocessing.events.OrderStatusChangedToCancelledIntegrationEvent;
import net.greeta.stock.analytics.streamprocessing.events.OrderStatusChangedToPaidIntegrationEvent;
import net.greeta.stock.analytics.streamprocessing.events.OrderStatusChangedToSubmittedIntegrationEvent;
...
import static net.greeta.stock.analytics.common.Constants.*;
