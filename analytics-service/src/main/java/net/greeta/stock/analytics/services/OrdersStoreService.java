...
import static net.greeta.stock.analytics.common.Constants.PAID_ORDER_IDS_STORE;
import static net.greeta.stock.analytics.common.Constants.SUBMITTED_ORDERS_STORE;
