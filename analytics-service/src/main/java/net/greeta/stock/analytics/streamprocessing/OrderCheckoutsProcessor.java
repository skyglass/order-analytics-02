...
import net.greeta.order.common.domain.dto.analytics.ProductSellCount;
import net.greeta.order.common.domain.dto.analytics.TopFiveProducts;
import net.greeta.stock.analytics.streamprocessing.events.UserCheckoutAcceptedIntegrationEvent;
